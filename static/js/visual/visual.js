$(document).ready(function() {
    ...
    // animacija pri nalaganju slik prek druge forme
    
    $("#animation-btn-2").click(function() {
        $("#dropbox-1").animate({marginLeft: "240px"}, 2000, "linear");
        $("#dropbox-2").animate({marginLeft: "-454px"}, 2000, "linear");
    });
    
    
    // upload gumb disabled dokler uporabnik ne izbere slike
    ...
    $('#animation-btn').click(function() {
        ...
        $('#img-container').css("top", "859px");
        $('#img-container').css("left", "592px");
...
$('input[type=file]').customFile();
        ...
        // prikaz slike namesto generične slike
